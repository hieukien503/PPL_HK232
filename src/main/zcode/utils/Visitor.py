...
class Visitor(ABC):
    ...
    def visitBoolType(self, ast, param): pass
    def visitNumberType(self, ast, param): pass
    ...
    def visitArrayLiteral(self, ast, param): pass
    def visitBooleanLiteral(self, ast, param): pass
    def visitStringLiteral(self, ast, param): pass
    def visitNumberLiteral(self, ast, param): pass

    def visitArrayCell(self, ast, param): pass
    def visitCallExpr(self, ast, param): pass
    def visitUnaryOp(self, ast, param): pass
    def visitBinaryOp(self, ast, param): pass
